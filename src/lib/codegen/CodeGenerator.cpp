...
void CodeGenerator::visit(ProgramNode &p_program) {
  ...
  // Hint: Maintain a table to lookup symbols that are visible in the current
  // scope,
  // TODO: Entering scope (Add symbols in the current scope to the 'visible
  // table')
  ...
  // TODO: Leaving scope (Remove symbols added by the current scope from the
  // 'visible table')
}
